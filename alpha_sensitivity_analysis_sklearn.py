...
from kneed import KneeLocator # Gardé pour comparaison visuelle optionnelle

# =============================================================================
# ÉTAPE 0 : CONFIGURATION
# =============================================================================
INPUT_BRUTE_MATRIX_CSV = 'matrice_brute_valeurs_reelles.csv'
OUTPUT_DIRECTORY = 'analyse_sensibilite_alpha_locale'
TARGET_TAXON = 'Albizia adianthifolia' # Assurez-vous que ce taxon est bien dans votre CSV
ALPHA_VALUES_TO_TEST = [0.0, 0.25, 0.5, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 0.99, 1.0]
EPSILON = 1e-9

# =============================================================================
# ÉTAPE 1 : FONCTIONS DE PRÉPARATION ET DE CALCUL
# =============================================================================
...
def find_optimal_k_triangle_method(distances: np.ndarray, max_k_ratio=0.25, k_default=7):
    ...
    x_vals, y_vals = np.arange(1, len(distances) + 1), distances
...
# =============================================================================
# ÉTAPE 3 : FONCTION PRINCIPALE D'ANALYSE
# =============================================================================
def main():
    """Exécute l'analyse de sensibilité de bout en bout à partir du CSV brut."""
    ...
    for idx, alpha in enumerate(ALPHA_VALUES_TO_TEST):
        ...
        y_vals = distances_to_target.values
        
        # Utiliser notre méthode de détection fiable
        n_neighbors = find_optimal_k_triangle_method(y_vals)
